...
/**
   ...
   */function hasBindings(widget){var _widget$parameters;return null===(_widget$parameters=widget.parameters)||void 0===_widget$parameters?void 0:_widget$parameters.some((param=>{if("repeatable"===param.type){var _param$fields;const hasFieldBindings=null===(_param$fields=param.fields)||void 0===_param$fields?void 0:_param$fields.some((f=>void 0!==f.bind));return"object"==typeof param.bind||hasFieldBindings&&"string"==typeof param.item_selector}return void 0!==param.bind}))}const widgetCutClipboard=[]}));
