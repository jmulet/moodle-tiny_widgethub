define("tiny_widgethub/controller/form_ctrl",["exports","../service/file_service","../service/template_service","../service/userstorage_service","../util"],(function(_exports,_file_service,_template_service,_userstorage_service,_util){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.Templates=_exports.FormCtrl=void 0,_exports.getFormCtrl=function(editor){let instance=formCtrlInstances.get(editor);instance||(instance=new FormCtrl(editor,(0,_userstorage_service.getUserStorage)(editor),(0,_template_service.getTemplateSrv)(),(0,_file_service.getFileSrv)(editor)),formCtrlInstances.set(editor,instance));return instance};
/**
