...
$string['backuprestoredsuccess'] = 'Backup restored successfully';
...
$string['bsbutton_icon_title'] = 'Button icon';
$string['bsbutton_instructions'] = 'Use this widget to create a link in the form of a button with an icon.';
$string['bsbutton_name'] = 'Button';
$string['bsbutton_url_title'] = 'Action URL';
...
$string['confirmtrust'] = 'I confirm that I trust the code in this widget definition.';
...
$string['ibcallout_instructions'] = 'Use this widget to highlight important information such as definitions, theorems, examples, or warnings.';
$string['ibcallout_introduction'] = 'Introduction';
$string['ibcallout_large'] = 'Large';
$string['ibcallout_name'] = 'Callout box (Liquid)';
$string['ibcallout_size'] = 'Box size';
$string['ibcallout_small'] = 'Small';
$string['ibcallout_tip'] = 'Tip';
$string['ibcallout_type'] = 'Callout type';
$string['ibcallout_warning'] = 'Warning';
...
$string['ibfiltercleanfont_category'] = 'Filters';
$string['ibfiltercleanfont_instructions'] = 'This filter removes font-size and font-family styles.';
$string['ibfiltercleanfont_name'] = 'Clear font styles';
$string['ibfiltercleanfont_stats'] = '{$a} styles have been removed.';
...
$string['importconfig'] = 'Import configuration settings';
...
$string['overridewidgets'] = 'Override existing widgets';
$string['paste'] = 'Paste';
$string['pluginname'] = 'WidgetHub';
$string['preview'] = 'Preview';
$string['printable'] = 'Printable';
$string['privacy:metadata:userpreference:tiny_widgethub_userprefs'] = 'This plugin stores user preferences.';
$string['properties'] = 'Properties';
$string['recents'] = 'Recent';
$string['refreshpreview'] = 'Refresh preview';
$string['remove'] = 'Remove';
$string['repoversion'] = 'Available version';
$string['restorewidgets'] = 'Restore widgets';
...
$string['sharecss'] = 'Share site CSS inside the editor iframe';
$string['showinstalledonly'] = 'Show installed only';
$string['status'] = 'Status';
$string['statuslocalonly'] = 'Local only';
$string['statusnew'] = 'New';
$string['statusupdateavailable'] = 'Update available';
$string['statusuptodate'] = 'Up to date';
$string['syncpartial'] = 'Updated {$a->success} out of {$a->total} widgets.';
$string['syncrepository'] = 'Update widgets';
$string['syncsuccess'] = 'Update successful';
$string['toggleview'] = 'Toggle view';
$string['unwrap'] = 'Unwrap';
$string['viewplugin'] = 'View widgethub plugin';
$string['widget'] = 'Widget';
$string['widgethub:manage'] = 'Manage widgets';
$string['widgethub:use'] = 'Use WidgetHub';
